...
const HandleReport = () => {
    ...
    return (
        <>
            ...
            <div className='container px-6 py-4 mx-auto mt-8 max-w-7xl md:h-screen lg:py-0'>
                    ...
                    <div className='flex justify-between pt-6'>
                        <div className='flex flex-col flex-1 pl-16'>
                            ...
                            <div className='container w-full max-w-3xl my-4'>
                                ...
                                <textarea maxLength={100} className=" mt-4 l w-full h-24 bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                                <div className='flex items-center justify-start gap-10 mt-3'>
                                    <button className='px-3 py-2 text-gray-100 bg-red-500 border-none rounded-md hover:bg-red-700'>Flag User</button>
                                    <button className='px-3 py-2 text-gray-100 bg-red-500 border-none rounded-md hover:bg-red-700'>Delete Content</button>
                                    <button className='px-3 py-2 text-gray-100 bg-red-500 border-none rounded-md hover:bg-red-700'>Request Ban</button>
                                    <button className='px-3 py-2 text-gray-100 bg-red-500 border-none rounded-md hover:bg-red-700'>No Action</button>
                                </div>
                            </div>
                        </div>
